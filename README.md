...
| 命令 | 说明 |
|------|------|
| `/persona [action]` | 人格操作（show/freeze/unfreeze） |
...
Ox 拥有自适应人格系统，能够根据编程语言和项目上下文调整其行为风格。

### 人格维度
- **expertise_level**: 专业水平（0.0-1.0）
- **prefers_conciseness**: 偏好简洁性（0.0-1.0）
- **refuses_unsafe_code**: 拒绝不安全代码（固定为 true）
- **communication_style**: 沟通风格（formal/casual）
- **problem_solving_approach**: 问题解决方式（analytical/creative）
